...
<html lang="en">
  <head>
    <title>Istrotech First Task</title>
    <meta charset="utf-8">
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-4 site-logo">
            <a href="/" class="text-black h2 mb-0">Task Blog 1</a>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 text-center">
            <p>
              {{ $setting->copyright }} | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://www.facebook.com/kamal.hawash99/" target="_blank" >Abo Kamal</a>
              </p>
          </div>
        </div>
      </div>
